...
* Preview pane no longer flickering/jerking during editing (as long as MathJax is disabled or is not rendering anything).
* Navigation on preview pane (cross-references, toc) now working.
