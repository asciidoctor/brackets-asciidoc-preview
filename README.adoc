...
IMPORTANT: Version 1.0.8 is using Asciidoctor 1.5.0 for rendering. This introduces
...
Clone the repository and invoke the following commands from the toplevel directory:
...
manager by pressing the btn:[Install from URL...] button and
entering the name of the generated zipfile into the input field.
