...
For better sytax highlighting of AsciiDoc, you may also want to install additional themes. I tried the 
https://github.com/MiguelCastillo[Themes] extension by Miguel Castillo. Themes do not all work equally
well for AsciiDoc, so you need to experiment. 'Vibrank Ink' is pretty colorful, for example.
